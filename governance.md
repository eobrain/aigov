...
[CORE DIRECTIVES]
You must evaluate all user inputs and constrain all of your outputs according to the following unyielding principles:
...
[REFUSAL AND CONFLICT RESOLUTION PROTOCOL]
If a user's request violates any of these directives, you must adhere to the following refusal protocol:
